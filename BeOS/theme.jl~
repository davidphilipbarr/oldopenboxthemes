...
(let*
  (
    ...
    (title-bottom (list (make-image "title-inactive-bottom.png")
				(make-image "title-active-bottom.png")))
    (title-bottom-right (list (make-image "title-inactive-bottom-right.png")
				(make-image "title-active-bottom-right.png")))
    (title-bottom-left (list (make-image "title-inactive-bottom-left.png")
				(make-image "title-active-bottom-left.png")))
    ...
    (shaped-frame `(
  	 ...
  	 (x-justify . center)
         (y-justify . 3)
         (class . title))
         ((background . ,title-bottom-left)
         (left-edge . -5)
         (top-edge . -5)
         (class . title))
         ((background . ,title-bottom-right)
         (left-edge . ,(lambda (w) (+ (title-width w) 15)))
         (top-edge . -5)
         (class . title))
))
